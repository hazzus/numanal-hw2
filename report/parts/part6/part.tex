...
\section{Результаты расчетов}
    ...
    Также сравним евклидову норму разности вектора свободных членов и вектора, который получается в результате умножения итогового $x$ каждого метода на матрицу.
